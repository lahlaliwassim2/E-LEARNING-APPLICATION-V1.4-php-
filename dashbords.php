  ...
  <main>
    ...
    <div class="container-fluid">             
      <div class="row">
        ...
        <div class=" m-0 col-10 col-md-10">
          ...
          <div class="row mt-4">
            ...
            <div class="col-xl-3 col-md-6 mb-3">
              <div class="col-12 rounded-3 p-3 pb-1  cls1">
             ...
             <!-- courses card -->
            <div class="col-xl-3 col-md-6 mb-3">
              <div class="col-12 rounded-3 p-3 pb-1  cls2">
            ...
            <div class="col-xl-3 col-md-6 mb-3">
              <div class="col-12 rounded-3 p-3 pb-1  cls3">
            ...
            <!-- users card -->
            <div class="col-xl-3 col-md-6 mb-3">
              <div class="col-12 rounded-3 p-3 pb-1  cls4">
