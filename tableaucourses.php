...
if($query->num_rows>0){
    while($row=$query->fetch_assoc()){ // Récupère les ligne de résultat sous forme de tableau associatif
...
<tr class="bg-white">
                      ...
                      <td class="align-middle"><?= $row['temps']?></td>
                      <td class="align-middle">
                        <span>
                         <a href="modifiercourses.php?id=<?= $row['id'];?>"> <svg 
                            width="19"
                            height="19"
                            viewBox="0 0 19 19"
                            fill="none"
                        ...
                        <span class="ms-4">
                       <a href="deletecourses.php?id=<?= $row['id']?>"> <svg
                            width="16"
                            height="18"
                            viewBox="0 0 16 18"
                            fill="none"
